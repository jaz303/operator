...
func (i *Invoker[Tx, Ext, I, O]) WithContextFunc(fn func(*echo.Context) context.Context) *Invoker[Tx, Ext, I, O] {
	i.ctx = fn
	return i
}

// WithInputMapper registers the binding's input mapper
func (i *Invoker[Tx, Ext, I, O]) WithInputMapper(fn func(*echo.Context) (*I, error)) *Invoker[Tx, Ext, I, O] {
	i.inputMapper = fn
	return i
}

// WithOutputMapper registers the binding's output mapper
func (i *Invoker[Tx, Ext, I, O]) WithOutputMapper(fn func(c *echo.Context, o *O) error) *Invoker[Tx, Ext, I, O] {
	i.outputMapper = fn
	return i
}

// WithJSONOutputFunc sets an output mapper that calls fn after setting the JSON content type
func (i *Invoker[Tx, Ext, I, O]) WithJSONOutputFunc(fn func(c *echo.Context, o *O) error) *Invoker[Tx, Ext, I, O] {
	i.outputMapper = fn
	return i
}

// WithJSONOutput sets an output mapper that writes the result of fn as JSON
func (i *Invoker[Tx, Ext, I, O]) WithJSONOutput(fn func(c *echo.Context, o *O) any) *Invoker[Tx, Ext, I, O] {
...
func (i *Invoker[Tx, Ext, I, O]) Go(c *echo.Context) error {
...
func (i *Invoker[Tx, Ext, I, O]) getContext(c *echo.Context) context.Context {
	return i.ctx(c)
}

func (i *Invoker[Tx, Ext, I, O]) getInputMapper() func(c *echo.Context) (*I, error) {
...
func (i *Invoker[Tx, Ext, I, O]) getOutputMapper() func(*echo.Context, *O) error {
